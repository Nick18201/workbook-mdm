...
def generate_workbook_chap4_v2(output_filename="Workbook_Chapitre_4_v2.pdf", theme="indigo"):
    ...
    builder.add_page(chap4_v2.create_chap4_v2_cover)
    builder.add_page(chap4_v2.create_concept_page)
    builder.add_page(chap4_v2.create_recap_seance_page)
    builder.add_page(chap4_v2.create_situation_actuelle_page)
    builder.add_page(chap4_v2.create_histoire_argent_page)
    builder.add_page(chap4_v2.create_premieres_experiences_page)
    builder.add_page(chap4_v2.create_argent_projet_pro_page)
    builder.add_page(chap4_v2.create_minimum_financier_page)
    builder.add_page(chap4_v2.create_archetypes_v2_page)
    builder.add_page(chap4_v2.create_synthese_v2_page)
