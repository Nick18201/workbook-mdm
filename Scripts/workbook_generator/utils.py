    ...
    for font_name, filename, style_attr in font_map:
        ...
        if os.path.exists(path):
            try:
                ...
                if style_attr == "FONT_TITLE": PDFStyle.FONT_TITLE = font_name
                if style_attr == "FONT_BRANDING": PDFStyle.FONT_BRANDING = font_name
                if style_attr == "FONT_BODY": PDFStyle.FONT_BODY = font_name
                if style_attr == "FONT_ITALIC": PDFStyle.FONT_ITALIC = font_name
                if style_attr == "FONT_HAND": PDFStyle.FONT_HAND = font_name
                if style_attr == "FONT_SUBTITLE": PDFStyle.FONT_SUBTITLE = font_name
