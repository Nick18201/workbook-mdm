...
# 📚 Le Catalogue des 8 Gabarits Standards
...
| **7** | **Engagement & Signature** | `create_standard_engagement_page(c, part_title, lines, title)` | Puces d'engagement + champ signature |
| **8** | **Clôture** | `create_closing_page(c, messages)` | Logo centré, félicitations et transition |
